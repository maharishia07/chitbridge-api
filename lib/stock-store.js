  ...
  return withEntity(entity_id, async (db) => {
    ...
    const ins = await db.query(
      `INSERT INTO stock_movement
         (entity_id, item_id, location, qty, rate, value_delta, unit, reason, ref, line_ref, lot, note, at, created_by)
      ...
      [entity_id, mv.item_id, location, inventory.signedQty(mv),
       ...
       mv.unit || null, mv.reason, mv.ref || null, mv.line_ref || null, mv.lot || null, mv.note || null,
