...
async function post(entity_id, mv, withEntity, opts) {
  ...
  return withEntity(entity_id, async (db) => {
     ...
     */
    await db.query(
      `INSERT INTO stock_balance (entity_id, item_id, location, lot, expires_at)
       VALUES ($1,$2,$3,$4,$5) ON CONFLICT DO NOTHING`,
      [entity_id, mv.item_id, location, lot, mv.expires_at || null]);
    ...
    const ins = await db.query(
      `INSERT INTO stock_movement
         (entity_id, item_id, location, qty, rate, value_delta, unit, reason, ref, line_ref, lot, note, at, created_by, expires_at)
      ...
      [entity_id, mv.item_id, location, inventory.signedQty(mv),
       ...
       mv.at || null, o.actor_id || null, mv.expires_at || null]);
