...
module.exports = { FLAGS, BOUND, defaults, get, set, coerce };   /* coerce is exported for tests/policy-defaults.test.js — a value rule nobody can exercise is a value rule nobody notices breaking */
