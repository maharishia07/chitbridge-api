    ...
    for (const n of childrenOf(parentKey)) {
      ...
      if (already) {
        ...
        const nowPlace = liveRow ? { address: liveRow.address, city: liveRow.city, country: liveRow.country,
                                     lat: liveRow.lat === null || liveRow.lat === undefined ? null : Number(liveRow.lat),
                                     lng: liveRow.lng === null || liveRow.lng === undefined ? null : Number(liveRow.lng),
                                     service_km: liveRow.service_km === null || liveRow.service_km === undefined ? null : Number(liveRow.service_km) } : null;
