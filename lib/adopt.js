...
'use strict';
// @stage tested
// @stage-note the rules are settled and proven (tests/adopt.test.js); no route mints an adopted product yet, and
// @stage-note that order is deliberate — a catalogue row created under a wrong rule is a product on a storefront.
