...
- A co-assist is anyone — or anything — that acts for you. You stay the party; they act FOR you under scoped
  access you grant. They sign in (username + PIN), can work shifts, and can take breaks or leave.
- Work is assigned by push (you hand it to them) or pull (they take from the pool); there is also bulk assign.
- A co-assist always acts within the entity's context, so they inherit the entity's privacy scope.
