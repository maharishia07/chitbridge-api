 ...
 *   (classic script shape · vendored to the browser as engine/jurisdiction.js, like the other engines)
 *
...
(function (root) {
  ...
  function payWays(o) {
    ...
    Object.keys(PAY_SCHEMES).forEach(function (id) {
      ...
      out.push({ id: id, label: s.label, qr: s.encodes, payee: String(v).trim() });
    });
