 ...
 *
 *   the footer   "10 waiting to reach ChitBridge"        ← reads as patience
 ...
 * @stage tested
 *
 * ⚠️ : no route reaches it yet. It is the single home for what a counter TELLS somebody when something
 * is wrong, and the surfaces are being moved onto it one at a time — the footer first, then 🩺, then the
 * counter-health page. Until they all read it, saying  would overstate it.
 */
...
const VERDICTS = [
  ...
  },
  {
    ...
    code: 'ALL_SENT',
    when: () => true,
    line: 'Everything has reached ChitBridge',
 ...
 *   online      did the last attempt reach ChitBridge at all
...
module.exports = { read, support, VERDICTS };
