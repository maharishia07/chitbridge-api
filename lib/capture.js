...
async function createCapture(entity_id, { channel, sender_ref, sender_name, subject, raw_text, media_refs, to_ref }) {
  ...
  try {
    const r = await withEntity(entity_id, (c) => c.query(
      ...
      `INSERT INTO capture (entity_id, channel, sender_ref, sender_name, subject, raw_text, media_refs, to_ref)
       VALUES ($1,$2,$3,$4,$5,$6,$7::jsonb,$8) RETURNING id, channel, sender_ref, sender_name, subject, raw_text, status, created_at`,
