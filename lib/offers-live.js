  ...
  try {
    ...
    if (cartAdj.length) {
      ...
      cartAdj.forEach((a) => {
        ...
        var src = offers.find(function (o) { return String(o.id) === String(a.offer_id); }); var pr = null; try { pr = (src && eng.promise) ? eng.promise(src, { now: new Date(), currency: entity.currency_code || 'INR', customer_groups: groups, money: function (n) { return String(n); } }) : null; } catch (_) {}
        let left = amt;
