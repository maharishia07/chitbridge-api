...
//
// @stage tested
// ⚠️ UNCALLED ON PURPOSE, AND THAT IS THE HONEST LABEL: built and covered by 6 tests, but nothing imports it yet.
// The one place it belongs is lib/consolidate.js — LOCKED engine code on the money path — so the two-line wiring
// is written up in BACKLOG-autonomous.md §30 and waits for Athi's confirm rather than being applied at night.
// Until that lands, group sum still reports `0 kg + 8 கிலோ` as un-summable. Do not read this file's existence as
// the fix being shipped.
//
