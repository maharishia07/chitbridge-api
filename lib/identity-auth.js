...
async function issueToken(query, identity) {
  const base = {
  ...
  return jwt.sign(base, process.env.JWT_SECRET, { expiresIn: '7d' });
}
...
module.exports = {
  findLoginIdentity, findEntityByNameOrHandle, needsPin, issueOtp, verifyCredential, issueToken, personShape,
  MAX_PIN_ATTEMPTS,
};
