...
async function liveOffers({ entity_id, withEntity, viewer, groups, all }) {
  try {
    ...
    const offers = r.rows
      .map((d) => { const rules = (d.rules && typeof d.rules === 'object') ? d.rules : {}; const alias = rules.alias != null ? String(rules.alias).trim() : '';
        const o = Object.assign({}, rules, { id: d.definition_id, label: alias || d.name, kind: d.sub_kind }); delete o.alias; return o; })
      .filter((o) => o.kind);
...
module.exports = { liveOffers, buildPublicView, getFace, orderInputOf, getOrderInput, catalogueVisibility };
