...
function summarise(rows) {
  ...
  const valued = list.filter((r) => r.currency && Number.isFinite(Number(r.value)));
...
module.exports = { isMoney, make, read, amountOf, amountOfLoose, currencyOf, times, sum, summarise, assertSameCurrency, format, round2, SHAPE, CODE_RE };
