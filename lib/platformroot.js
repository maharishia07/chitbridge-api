'use strict';
// @stage tested
// @stage-note THE deployment root resolver — and, since b252, the per-POPULATION desk resolver. Called by
//             lib/raiseticket on every support ticket and by routes/entities on the Platform screen. It was
//             tagged `held` until 2026-09-14 and the tag stayed behind after the callers arrived, which told
//             the next reader this file was inert. Off by default is still true: with nothing configured,
//             root() is null and every caller behaves as it did before there was a root.
