// @stage proven
// @stage-note Ran end to end in scripts/prototype-form16-to-itr2.js against a real PDF (12 of 17 fields, with provenance). 17 assertions. NOT in a route: the browser re-implements extraction in shop.html, and coverage() is not surfaced anywhere. Wiring it needs the two implementations to be shown to agree first.
