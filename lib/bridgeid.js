...
// ⭐ Registered in docs/namespace.yaml (kind: bridge_id) — the alphabet and length below are asserted
//    against it by tests/namespace.test.cjs, so this file and the register cannot drift apart.
//
