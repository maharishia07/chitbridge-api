...
async function raise(from, who, t) {
  ...
  try {
    ...
    return { raised: true, chit_id, folder: folderName, assigned: !!route.assignee_actor_id,
             routed: route.why + (isSelf ? ' · raised and held here' : ' · sent to ' + (op.display_name || 'the team')) };
  } catch (e) {
