...
async function mint(owner, name, deps) {
  ...
  for (let attempt = 0; attempt < 5; attempt++) {
    ...
    try {
      ...
      const r = await query(
        `INSERT INTO identities (bridge_id, display_name, user_id, identity_type, parent_entity_id, status, created_by, entity_kind)
         VALUES ($1, $2, $3, 'entity', $4, 'active', $4, 'supplier')
