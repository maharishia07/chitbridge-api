...
(function (root) {
  ...
  var REASONS = {
    ...
    /* ⭐ A SUPPLY LEAVING TO BE USED (b217). Not a sale and NOT shrinkage — nothing went missing, the shop
       consumed it on purpose. Separating it is what turns a pile of sundry purchases into a spend figure a
       person can read: "₹2,300 of packaging used in July". Folded into shrinkage it would look like loss. */
    issued:          { dir: 'out',                      says: 'used by the shop' },
