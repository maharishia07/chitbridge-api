-- ═══════════════════════════════════════════════════════════════════════════════════════════════════════════════
-- b158 — CONNECT THE SHOPS THAT REGISTERED BEFORE THERE WAS A ROOT.
-- ═══════════════════════════════════════════════════════════════════════════════════════════════════════════════
--
...
--
-- ⚠️ REQUIRES b157. The predicate is `entity_kind = 'customer'`. Without b157 the only way to say that was
...
--    written today, and only b157 makes it safe to run at all.
--
...
-- ⚠️ IF root_found IS 0, STOP. Either cbincroot does not exist or b157 did not mark it 'internal', and every
