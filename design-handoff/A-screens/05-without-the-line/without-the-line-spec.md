...
| **No line** | nothing reaches the shop | `no line · 8 waiting`, grey, never red — a shop with no line is not a broken shop | Keep selling — nothing is lost |
...
5. Counts everywhere: *7 of 7 working*, *8 waiting*, *6 need the line*, *oldest 1:14 pm*.
