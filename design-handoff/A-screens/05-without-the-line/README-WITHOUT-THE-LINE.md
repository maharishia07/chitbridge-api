...
| No line | nothing gets through | `no line · 8 waiting` | grey — never red |
...
```
Read EVERY file in design-handoff/without-the-line/ first — every .md and every .png — before writing any code.
