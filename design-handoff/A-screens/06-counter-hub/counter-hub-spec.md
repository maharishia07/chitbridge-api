...
| Fix | |
|---|---|
| The **shop** is the title; **Counter 1** (not "Counter") moves to the subtitle | superseded by fine/05-headers §2 — the shop is what is printed on every bill |
...
3. Signed in → initials, name, and **how long they have been on** (*since 9:41 am · 4h 33m*) — that is what a hand-over needs.
...
## 9. The "CAREFUL" footer — dissolve it

Today a pink strip is pinned to the bottom of the hub for ever: **CAREFUL · These stop billing for a moment. Everything is sent and checked first.** with *Sign out · Clear and reload · Close this counter*. Design: `png/HubFooter.png`.

### Why it fails

1. A red box is the loudest thing on a calm screen, and it is there every second of every day — so by the second day nobody sees it.
2. The three actions share nothing but the warning: one is hourly, one is once a day, one is a repair nobody should need.
3. "These stop billing for a moment" is true of one of them. Sign out does not stop billing; the next person signs in.
4. "Everything is sent and checked first" is a promise made *before* the button is pressed, where it cannot be measured against the actual numbers.
5. The most dangerous of the three sits at the far right, where a hand lands by accident.

### Where each one belongs

| Action | Home | Why |
|---|---|---|
| **Sign out** | the person block, in the header — beside Hand over | It belongs to whoever is standing there. Most frequent, least dangerous. |
| **Close this counter** | the day card | Opening and closing the day are the same job at two ends. Once the day is open, that card's button becomes **Close the day**, with the day close sheet one tap on. |
| **Clear and reload** | Counter health ▸ Show technical detail ▸ **Repair this counter** | It is a repair, not a daily action, and it belongs beside the numbers it affects. |

The warning goes with them — as one sentence at the moment the button is pressed, where it is actually read.

### If a footer must stay (option B)

Make it furniture, not an alarm: one line high, no fill, a hairline above it, carrying *who is on · which counter · day state*, with **Sign out** plain on the right and the rare or risky things behind **⋯** (Close this counter · Clear and reload · About this counter). The word CAREFUL disappears; caution is shown by where a thing is, not by shouting.

### The confirm sheet, which replaces the standing warning

> **Close this counter?**
> Billing stops until someone opens it again. Nothing is lost.
> ✓ Bills sent to the shop — **96 of 96**  ·  ✓ Waiting to send — **none**  ·  ✓ Bills in hand — **none**  ·  ~ Cash counted — *not yet, the sheet asks next*
> [ Not now ]  **[ Close the counter ]**

Rules:

1. A warning belongs at the moment of the act, never standing on the screen beforehand.
2. Say the consequence, not the adjective: *billing stops until someone opens it again*.
3. Show the numbers the promise depends on — 96 of 96 sent, none waiting, none in hand.
4. Name the button with the verb: **Close the counter**, never OK.
5. The safe way out is first and plain: **Not now**.
6. If a check fails, the sheet says so and the button changes: **Send 3 first, then close**.

### Extra acceptance checks

11. No standing warning banner appears anywhere in the hub.
12. Sign out sits with the person; Close the day sits on the day card; Clear and reload sits in the technical view.
13. Every one of the three opens a confirm sheet that states the consequence and shows live numbers.
14. With bills still waiting, the close sheet's primary button becomes "Send N first, then close".
